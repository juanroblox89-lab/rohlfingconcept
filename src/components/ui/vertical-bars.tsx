...
/**
 * Fondo animado de barras con ruido — reacciona al mouse y genera ondas
 * al hacer clic. Se adapta al tamaño de su contenedor padre (no a la ventana).
 */
const VerticalBarsNoise = ({
  ...
  const resizeCanvas = useCallback(() => {
    ...
    // Tamaño del contenedor padre (no de la ventana)
